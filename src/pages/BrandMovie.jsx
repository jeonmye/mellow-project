  ...
  return (
    <div className="w-full flex flex-col items-center gap-10">
      <div className="w-full h-[400px] overflow-hidden relative md:p-0 mb-14">
        ...
        <span className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-h1-bold text-white text-h2-bold md:text-h1-bold lg:text-[65px]">
          2020 LB세미콘 기술홍보
        </span>
      </div>
      ...
      <div className="w-full max-w-[1000px] aspect-w-16 aspect-h-9 relative">
        <ReactPlayer
